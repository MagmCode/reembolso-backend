...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(days=1),   
     'USER_ID_FIELD': 'username',  # Usar el campo 'username' (cédula) en lugar de 'id'
    'USER_ID_CLAIM': 'username',  # Usar el campo 'username' en el token # Duración del token de refresco
}
...
MIDDLEWARE = [
    ...
    'middleware.NoCacheMiddleware',  # Middleware personalizado
...
STATIC_URL = 'Apps/Aplicacion/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'Apps/Aplicacion/static')
